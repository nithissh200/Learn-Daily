...
- [ Escalating a P5 bug to P2 vulnerability - Blind XSS ](https://medium.com/@mohameddaher/from-p5-to-p5-to-p2-from-nothing-to-1000-bxss-4dd26bc30a82)

- [ Google Acquisition XSS - APIgee ](https://medium.com/@TnMch/google-acquisition-xss-apigee-5479d7b5dc4)

- [ Reflected XSS via Angular JS template injection - Microsoft](https://infosecwriteups.com/reflected-xss-on-microsoft-com-via-angular-template-injection-2e26d80a7fd8)
